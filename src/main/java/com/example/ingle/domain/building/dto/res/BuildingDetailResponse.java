...
public record BuildingDetailResponse(@Schema(description = "건물 Id", example = "1") Long buildingId,
                                     @Schema(description = "건물 이름", example = "대학본부") String buildingName,
                                     @Schema(description = "위도", example = "37.376833680573") Double latitude,
                                     @Schema(description = "경도", example = "126.6347435192162") Double longitude,
                                     @Schema(description = "건물 카테고리", example = "SCHOOL_BUILDING") BuildingCategory buildingCategory,
                                     @Schema(description = "호관", example = "1") Integer buildingNumber,
                                     @Schema(description = "건물 코드", example = "SH") String buildingCode,
                                     @Schema(description = "위치", example = "복지회관") String location,
