...
public record LoginSuccessResponse(@Schema(description = "회원 Id", example = "1") Long memberId,
                                   @Schema(description = "학번", example = "202301452") String studentId,
                                   @Schema(description = "학과", example = "Dept. of Computer Science & Engineering") String department,
                                   @Schema(description = "파견 유형", example = "Exchange Student") String program,
                                   @Schema(description = "닉네임", example = "IngleFan") String nickname,
                                   ...
                                   @Schema(description = "Access Token 만료 일시 (Date)", example = "2025-05-14T15:30:00.000+09:00") Date accessTokenExpiresDate,
                                   @Schema(description = "Refresh Token 만료 일시 (Date)", example = "2025-05-14T15:30:00.000+09:00") Date refreshTokenExpiresDate
