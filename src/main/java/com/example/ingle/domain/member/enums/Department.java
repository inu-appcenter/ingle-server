...
public enum Department {
    ...
    CHINESE_STUDIES("중어중국학과"),
    GERMAN_STUDIES("독어독문학과"),
    FRENCH_STUDIES("불어불문학과"),
    MATHEMATICS("수학과"),
    PHYSICS("물리학과"),
    CHEMISTRY("화학과"),
    ...
    MEDIA_COMMUNICATION("신문방송학과"),
    LIBRARY_INFO("문헌정보학과"),
    CREATIVE_HRD("창의인재개발학과"),
    PUBLIC_ADMINISTRATION("행정학과"),
    POLITICS_DIPLOMACY("정치외교학과"),
    ECONOMICS("경제학과"),
    TRADE("무역학부"),
    ...
    URBAN_ADMIN("도시행정학과"),
    CIVIL_ENVIRONMENT_ENG("도시환경공학부"),
    URBAN_ENG("도시공학과"),
    ARCHITECTURE_ENG("도시건축학과"),
    LIFE_SCIENCE("생명과학부"),
    BIOENGINEERING("생명공학부"),
    NANO_BIO("나노바이오전공"),
    NORTHEAST_ASIAN_TRADE("동북아국제통상학부"),
    KOREA_TRADE("한국통상전공"),
    LAW("법학부");
